 ...
 * @author Andrew Post
 */
public class I2B2DataSourceBackend extends RelationalDbDataSourceBackend {
    ...
    protected EntitySpec[] constantSpecs(String keyIdSchema, String keyIdTable, String keyIdColumn, String keyIdJoinKey) throws IOException {
        ...
        return new EntitySpec[] {
            new EntitySpec("Patients", 
                    ...
                    new ReferenceSpec[]{
                        new ReferenceSpec("encounters", "Encounters", new ColumnSpec[]{new ColumnSpec(keyIdSchema, keyIdTable, new JoinSpec("patient_num", "patient_num", new ColumnSpec(schemaName, VISIT_DIMENSION, "encounter_num")))}, ReferenceSpec.Type.MANY), 
                        new ReferenceSpec("patientDetails", "Patient Details", new ColumnSpec[]{new ColumnSpec(keyIdSchema, keyIdTable, "patient_num")}, ReferenceSpec.Type.MANY)}, 
            ...
            new EntitySpec("Patient Details", 
                    ...
                    new PropertySpec[]{
                        new PropertySpec("patientId", null, new ColumnSpec(keyIdSchema, keyIdTable, "patient_num"), ValueType.NOMINALVALUE), 
                        new PropertySpec("gender", null, new ColumnSpec(schemaName, PATIENT_DIMENSION, "SEX_CD", ColumnSpec.Constraint.EQUAL_TO, this.mapper.propertyNameOrPropIdToSqlCodeArray("gender_07182011.txt"), true), ValueType.NOMINALVALUE), 
                        new PropertySpec("race", null, new ColumnSpec(schemaName, PATIENT_DIMENSION, "RACE_CD", ColumnSpec.Constraint.EQUAL_TO, this.mapper.propertyNameOrPropIdToSqlCodeArray("race_07182011.txt"), true), ValueType.NOMINALVALUE), 
                        new PropertySpec("ethnicity", null, new ColumnSpec(schemaName, PATIENT_DIMENSION, "RACE_CD", ColumnSpec.Constraint.EQUAL_TO, this.mapper.propertyNameOrPropIdToSqlCodeArray("ethnicity_07182011.txt"), true), ValueType.NOMINALVALUE)}, 
                    new ReferenceSpec[]{
                        new ReferenceSpec("encounters", "Encounters", new ColumnSpec[]{new ColumnSpec(schemaName, PATIENT_DIMENSION, new JoinSpec("patient_num", "patient_num", new ColumnSpec(schemaName, VISIT_DIMENSION, "encounter_num")))}, ReferenceSpec.Type.MANY), 
                        new ReferenceSpec("patient", "Patients", new ColumnSpec[]{new ColumnSpec(schemaName, PATIENT_DIMENSION, "patient_num")}, ReferenceSpec.Type.ONE)}, 
                    null, null, null, null, null, null, null, null),
    ...
    protected EntitySpec[] eventSpecs(String keyIdSchema, String keyIdTable, String keyIdColumn, String keyIdJoinKey) throws IOException {
        ...
        EntitySpec[] eventSpecs = {
            new EntitySpec("Encounters", 
                    ...
                    true, 
                    new ColumnSpec(keyIdSchema, keyIdTable, new JoinSpec("patient_num", "patient_num", new ColumnSpec(schemaName, VISIT_DIMENSION, "encounter_num"))), 
                    new ColumnSpec[]{
                    ...
                    new PropertySpec[]{
                        ...
                        /*new PropertySpec("age", null, new ColumnSpec(schemaName, VISIT_DIMENSION, "ADMISSIONAGEYEARS"), ValueType.NUMBERVALUE), 
                    ...
                    new ReferenceSpec[]{
                        new ReferenceSpec("patient", "Patients", new ColumnSpec[]{new ColumnSpec(schemaName, VISIT_DIMENSION, "patient_num")}, ReferenceSpec.Type.ONE), 
            ...
            new EntitySpec("Diagnosis Codes", 
                    null, 
                    this.mapper.readCodes("icd9_diagnosis_07182011.txt", 0), 
                    true, 
                    new ColumnSpec(keyIdSchema, keyIdTable, new JoinSpec("patient_num", "patient_num", new ColumnSpec(schemaName, VISIT_DIMENSION, new JoinSpec("encounter_num", "encounter_num", new ColumnSpec(schemaName, OBSERVATION_FACT))))), 
                    new ColumnSpec[]{
                        new ColumnSpec(schemaName, VISIT_DIMENSION, new JoinSpec("encounter_num", "encounter_num", new ColumnSpec(schemaName, OBSERVATION_FACT, "encounter_num"))),
                        new ColumnSpec(schemaName, VISIT_DIMENSION, new JoinSpec("encounter_num", "encounter_num", new ColumnSpec(schemaName, OBSERVATION_FACT, "concept_cd"))),
                        new ColumnSpec(schemaName, VISIT_DIMENSION, new JoinSpec("encounter_num", "encounter_num", new ColumnSpec(schemaName, OBSERVATION_FACT, "provider_id"))),
                    ...
                    null, 
                    null, 
                    new ColumnSpec(schemaName, OBSERVATION_FACT, "concept_cd", ColumnSpec.Constraint.LIKE, this.mapper.propertyNameOrPropIdToSqlCodeArray("icd9_diagnosis_07182011.txt"), true), 
                    null, null, null, 
            ...
            new EntitySpec("ICD9 Procedure Codes", 
                    null, 
                    this.mapper.readCodes("icd9_procedure_07182011.txt", 0), 
                    true, 
                    new ColumnSpec(keyIdSchema, keyIdTable, new JoinSpec("patient_num", "patient_num", new ColumnSpec(schemaName, VISIT_DIMENSION, new JoinSpec("encounter_num", "encounter_num", new ColumnSpec(schemaName, OBSERVATION_FACT))))), 
                    new ColumnSpec[]{
                        new ColumnSpec(schemaName, VISIT_DIMENSION, new JoinSpec("encounter_num", "encounter_num", new ColumnSpec(schemaName, OBSERVATION_FACT, "encounter_num"))),
                    ...
                    new ColumnSpec(schemaName, OBSERVATION_FACT, "concept_cd", ColumnSpec.Constraint.LIKE, this.mapper.propertyNameOrPropIdToSqlCodeArray("icd9_procedure_07182011.txt"), true), 
                    null, null, null, 
                    AbsoluteTimeGranularity.DAY, 
                    POSITION_PARSER, 
                    null),
