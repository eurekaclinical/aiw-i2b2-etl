...
class LevelReader {
    ...
    Map<String, List<String>> readChildrenFromDatabase(final Collection<String> symbols) throws KnowledgeSourceReadException {
    ...
    private static final ResultSetReader<Map<String, List<String>>> MULT_RESULT_SET_READER = new ResultSetReader<Map<String, List<String>>>() {
        ...
        public Map<String, List<String>> read(ResultSet rs) throws KnowledgeSourceReadException {
            try {
                ...
                while (rs.next()) {
                    putList(result, rs.getString(1), rs.getString(2));
                }
                return result;
            } catch (SQLException ex) {
                throw new KnowledgeSourceReadException(ex);
