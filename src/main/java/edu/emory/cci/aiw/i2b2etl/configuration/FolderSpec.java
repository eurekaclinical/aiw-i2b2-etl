...
public class FolderSpec {
    ...
    public FolderSpec(String displayName, String[] propositions, String property, String conceptCodePrefix, ValueTypeCode valueType, boolean userDefined, ModifierSpec[] modifiers) {
