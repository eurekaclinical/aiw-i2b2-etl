 ...
 * @author Andrew Post
 */
public abstract class AbstractDataAndMetadataTest extends AbstractTest {

    private static ConfigurationFactory configFactory;

    protected AbstractDataAndMetadataTest() {
    }

    @BeforeClass
    public static void setUpClsAbstractDataTest() throws Exception {
        configFactory = new ConfigurationFactory("/conf_not_already_loaded.xml");
    }
